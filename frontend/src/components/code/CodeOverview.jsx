...
/**
 * Code Overview Component
 * 
 * Displays statistics for generated code:
 * - Total code files
 * - Code types distribution
 * - Quality score distribution
 * - Generation status
 */
export default function CodeOverview({ onRefresh }) {
  ...
  const loadOverview = async () => {
    ...
    try {
      ...
      console.error('Error loading code overview:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ 
        ...
        <h2 style={{ margin: 0, color: '#333' }}>Code Overview</h2>
        <button 
